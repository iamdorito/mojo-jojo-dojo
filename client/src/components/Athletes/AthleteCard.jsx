...
export default function AthleteCard({ fighter, getGymName, user }) {
    ...
    {user ? 
        ...
        <div class="flex items-center p-1 border border-purple-600 dark:border-purple-400 rounded-xl">
            <button
                className="px-4 py-2 text-sm font-medium text-purple-600 capitalize transition-colors duration-300 md:py-3 focus:outline-none hover:bg-purple-600 hover:text-white rounded-xl md:px-12"
                type="button"
