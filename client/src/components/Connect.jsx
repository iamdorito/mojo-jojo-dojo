  ...
  return (
    ...
    <div class="h-[32rem] bg-gray-100 dark:bg-gray-800">
      <div class="container px-6 py-10 mx-auto">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">THE EXECUTIVES</h2>
        ...
        <p class="max-w-2xl mx-auto mt-6 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
          {people.map((person) => (
            <div class="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                <img class="object-cover w-full rounded-xl aspect-square" src={person.imageUrl} alt={person.name}/>

                <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">{person.name}</h1>

                <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">{person.role}</p>
{/* 
